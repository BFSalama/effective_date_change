...
class InventoryAdjustmentDate(models.Model):
    ...
    def _apply_inventory(self):
        ...
        test = self.accounting_date
        super(InventoryAdjustmentDate, inventories.with_context(force_period_date=test))._apply_inventory()
        ...
        moves.with_context(force_period_date=test)._action_done()
